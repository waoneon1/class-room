...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-sm text-gray-500 mt-0.5">Daftar kelas yang tersedia</p>
    </div>
    ...
    <table class="w-full text-sm">
        <thead>
            <tr class="border-b border-gray-100">
                <th class="text-left px-5 py-3.5 text-gray-500 font-medium">Nama Kelas</th>
                <th class="text-left px-5 py-3.5 text-gray-500 font-medium">Jumlah Siswa</th>
        ...
        <tbody class="divide-y divide-gray-50">
            ...
            @empty
            <tr>
                <td colspan="3" class="px-5 py-10 text-center text-gray-400 text-sm">Belum ada kelas.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
