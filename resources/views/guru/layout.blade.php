...
<head>
    ...
    <title>@yield('title', 'Guru') — SDN Ketintang II</title>
    ...
    <div class="bg-primary h-16 flex items-center px-4 md:px-6 gap-4 fixed top-0 left-0 right-0 z-20">
        ...
        <div class="flex items-center gap-2 md:gap-3">
            <div class="text-right hidden sm:block">
                ...
                <p class="text-primary-light text-xs">Guru</p>
            </div>
        ...
        <aside id="sidebar" class="w-[220px] bg-primary min-h-screen fixed left-0 top-16 bottom-0 z-20 flex flex-col py-6 -translate-x-full md:translate-x-0 transition-all duration-200">
            <nav class="flex-1 px-3 space-y-1">
                <a href="{{ route('guru.dashboard') }}"
                   class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors {{ request()->routeIs('guru.dashboard') ? 'bg-white/20 text-white font-semibold' : 'text-primary-light hover:bg-white/10 hover:text-white' }}">
                ...
                <a href="{{ route('guru.materi.index') }}"
                   class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors {{ request()->routeIs('guru.materi*') ? 'bg-white/20 text-white font-semibold' : 'text-primary-light hover:bg-white/10 hover:text-white' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                    </svg>
                ...
                <a href="{{ route('guru.tugas.index') }}"
                   class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors {{ request()->routeIs('guru.tugas*') || request()->routeIs('guru.pengumpulan*') ? 'bg-white/20 text-white font-semibold' : 'text-primary-light hover:bg-white/10 hover:text-white' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('guru.rekap-nilai.index') }}"
                   class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors {{ request()->routeIs('guru.rekap-nilai*') ? 'bg-white/20 text-white font-semibold' : 'text-primary-light hover:bg-white/10 hover:text-white' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
